...
public class ClinicAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ClinicAdapter(Context context, List<ClinicDetails> clinicDetailsList, OnNoteListener onNoteListener1) {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            onNoteListener.onNoteClick(getAbsoluteAdapterPosition(), clinicDetailsList);
        }
    }
